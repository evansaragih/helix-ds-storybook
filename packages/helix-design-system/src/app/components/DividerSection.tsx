      ...
      <Section id="divider-orientation" title="Orientation">
        ...
        <DemoCard title="Vertical divider in a row">
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, height: 32 }}>
            <span style={{ fontFamily: 'var(--font-family-body)', fontSize: 13, color: '#49494A' }}>Section A</span>
            <Divider orientation="vertical" style={{ height: 20 }} />
            <span style={{ fontFamily: 'var(--font-family-body)', fontSize: 13, color: '#49494A' }}>Section B</span>
            <Divider orientation="vertical" style={{ height: 20 }} />
            <span style={{ fontFamily: 'var(--font-family-body)', fontSize: 13, color: '#49494A' }}>Section C</span>
          </div>
        </DemoCard>
      </Section>
