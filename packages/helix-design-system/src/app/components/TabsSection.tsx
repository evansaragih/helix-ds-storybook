...
const contentItems = [
  {
    ...
    content: <p style={{ margin: 0, fontFamily: 'Rubik, sans-serif', fontSize: 13, color: '#49494A' }}>Dashboard panel — charts and KPIs would live here.</p>,
  },
  {
    id: 'profile',
    label: 'Profile',
    icon: <User size={14} />,
    content: <p style={{ margin: 0, fontFamily: 'Rubik, sans-serif', fontSize: 13, color: '#49494A' }}>Profile panel — user details and preferences.</p>,
  },
  {
    id: 'settings',
    label: 'Settings',
    icon: <Settings size={14} />,
    content: <p style={{ margin: 0, fontFamily: 'Rubik, sans-serif', fontSize: 13, color: '#49494A' }}>Settings panel — account and notification preferences.</p>,
  },
];
