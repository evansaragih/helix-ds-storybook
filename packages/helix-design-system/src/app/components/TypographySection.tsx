    ...
    >
      <Section id="font-families" title="Font Families">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
          {[
            { name: 'var(--font-family-heading)', role: 'Headings', family: 'var(--font-family-heading)' },
            { name: 'var(--font-family-body)', role: 'Body Text', family: 'var(--font-family-body)' }
          ].map((f) => (
            <div key={f.name} style={{ ...card, marginBottom: 0 }}>
              ...
              <p style={{ fontFamily: 'var(--font-family-body)', fontSize: '12px', color: '#828282', margin: '0 0 12px' }}>{f.role}</p>
      ...
      <Section id="type-scale" title="Type Scale">
        <h3 style={{ margin: '0 0 12px', fontFamily: 'var(--font-family-body)', fontWeight: 600, fontSize: '14px', color: '#828282', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Display</h3>
        {[
          ...
          <div key={item.name} style={card}>
            ...
            <p style={{ fontFamily: 'var(--font-family-body)', fontSize: '12px', color: '#828282', margin: 0 }}>{item.label}</p>
          </div>
        ))}

        <h3 style={{ margin: '24px 0 12px', fontFamily: 'var(--font-family-body)', fontWeight: 600, fontSize: '14px', color: '#828282', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Headings</h3>
        {[
        ...
        <h3 style={{ margin: '24px 0 12px', fontFamily: 'var(--font-family-body)', fontWeight: 600, fontSize: '14px', color: '#828282', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Body</h3>
        {[
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
          {[
            ...
            <div key={item.name} style={{ ...card, marginBottom: 0 }}>
              <p style={{ fontFamily: 'var(--font-family-body)', fontSize: '20px', fontWeight: item.weight, color: '#14141e', margin: '0 0 4px' }}>{item.name}</p>
              <p style={{ fontFamily: 'var(--font-family-body)', fontSize: '12px', color: '#828282', margin: 0 }}>{item.value}</p>
            </div>
          ))}
        </div>
      </Section>
